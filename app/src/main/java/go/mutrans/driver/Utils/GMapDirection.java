...
import go.mutrans.driver.Models.Direction;
...
public class GMapDirection {
    ...
    public String getUrl(LatLng start, LatLng end, String mode, boolean isAlternative, Activity context) {
    ...
    public String getUrlVia(Activity context,String mode, boolean isAlternative, LatLng start, LatLng... end) {
    ...
    public Document getDocument(LatLng start, LatLng end, String mode,Activity context) {
...
//                + "&sensor=false&units=metric&mode=driving"+"alternatives=true";
    ...
    public Document getDocument(String origin, String destination, String mode, Activity context) {
